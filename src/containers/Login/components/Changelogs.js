        ...
        <Typography variant="caption">
          ...
          <ul>
            <li>
              ...
              {' '}
              <br />
              All charts have been re-made with a specific attention to
              {' '}
              <strong>performance, ease of use and esthetics.</strong>
              <br />
            ...
            <li>
              Kaktana now supports Bittrex, Coinbase Pro and ByBit!
              <br />
            </li>
          </ul>
          ...
          <ul>
            <li>
              Limit buy orders are now available:
              {' '}
              <br />
          ...
          <ul>
            <li>
              Bots are now faster (~25s refresh period).
              {' '}
              <br />
